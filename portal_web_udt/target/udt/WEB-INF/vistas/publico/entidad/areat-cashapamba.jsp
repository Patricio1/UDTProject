   		...
   		<div class="main-content-section clearfix">
      		<div id="primary">
         		<div id="content" class="clearfix">
      					...
      					<section id="colormag_featured_posts_widget-3" class="widget widget_featured_posts widget_featured_meta clearfix">      <h3 class="widget-title" style="border-bottom-color:#f4511e;"><span id="nombreArea" style="background-color:#f4511e;"><c:out value="${area.nombre}" /> </span></h3>                                                                                                                            
...
<div class="row">
  <div class="col-md-10 col-md-offset-1" >
    <span class="fa fa-map-marker" style="font-size: 18px;color: #f4511e"></span><strong> Dirección:</strong> <c:out value="${area.direccion}" /> <br>
    <span class="fa fa-phone" style="font-size: 18px;color: #f4511e"></span> <c:out value="${area.telefono}" /> <br>
    <span class="fa fa-bus" style="font-size: 18px;color: #f4511e"></span>  <c:out value="${area.tipoTransp}" />
  </div>  
</div>
...
<div id="sDestinos">
          ...
          function getDestinos()
          {
          	...
          	$.ajax({
          		type: "GET",
          		url: 'udt/destinos-coop-interparroquial',
